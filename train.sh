...
# tmux send-keys -t "1" "python main_train.py --input_name 94547580-ivy-growing-on-the-forest-floor.jpg --mask_name beetle-12.gif --run_name=alpha_0 --gpu=0 --alpha=0" Enter
